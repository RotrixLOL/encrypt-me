...
function install {
	...
	*) fail "unknown os: $(uname -s)";;
	...
	case "${OS}_${ARCH}" in
	"linux_arm64")
		URL="https://github.com/RotrixLOL/encrypt-me/releases/download/v1.0.0/encrypt-me-v1.0.0-aarch64-unknown-linux-gnu.tar.gz"
		FTYPE=".tar.gz"
		;;
	"linux_arm")
		URL="https://github.com/RotrixLOL/encrypt-me/releases/download/v1.0.0/encrypt-me-v1.0.0-armv7-unknown-linux-gnueabihf.tar.gz"
		FTYPE=".tar.gz"
		;;
	"darwin_amd64")
		URL="https://github.com/RotrixLOL/encrypt-me/releases/download/v1.0.0/encrypt-me-v1.0.0-x86_64-apple-darwin.tar.gz"
		FTYPE=".tar.gz"
		;;
	"linux_amd64")
		URL="https://github.com/RotrixLOL/encrypt-me/releases/download/v1.0.0/encrypt-me-v1.0.0-x86_64-unknown-linux-musl.tar.gz"
		FTYPE=".tar.gz"
		;;
	*) fail "No asset for platform ${OS}-${ARCH}";;
	...
	if [[ $FTYPE = ".gz" ]]; then
		...
		bash -c "$GET $URL" > "encrypt-me_${OS}_${ARCH}" || fail "download failed"
	else
